...
export const FAST_STORIES_REGULATION: FastStoryItem[] = [
  {
    id: 'fear',
    label: 'peur',
    description: 'Craintes, angoisses, sentiment d\'insécurité',
    icon: '🌑',
  ...
  },
  {
    id: 'sadness',
    label: 'tristesse',
    description: 'Chagrin, peine, besoin de réconfort',
    icon: '🌧️',
  ...
  },
  {
    id: 'stress',
    label: 'stress',
    description: 'Tension nerveuse, surcharge mentale',
    icon: '⚡',
...
export const FAST_STORIES_SITUATIONS: FastStoryItem[] = [
  {
    id: 'situation_dark',
    label: 'le coucher',
    description: 'Contexte du sommeil et de la pénombre.',
    icon: '🌙',
  ...
  },
  {
    id: 'situation_school',
    label: 'l\'école',
    description: 'Contexte lié à la classe, aux examens et aux devoirs.',
    icon: '🏫',
    promptKey: 'fast_story_situation_school',
    section: 'situation',
  ...
  },
  {
    ...
    label: 'séparation',
    description: 'Quitter ses parents, école, nounou.',
    icon: '🏡',
  ...
  {
    id: 'situation_grief',
    label: 'perte et deuil',
    description: 'Perte d\'un proche ou d\'un animal.',
    icon: '🕊️',
  ...
  {
    id: 'situation_conflict',
    label: 'conflit et dispute',
    description: 'Contexte relationnel difficile avec d\'autres enfants ou la fratrie.',
    icon: '⚡',
    promptKey: 'fast_story_situation_conflict',
    section: 'situation',
  ...
  },
  {
    ...
    description: 'Modifier des comportements répétitifs comme le temps excessif devant les écrans.',
    icon: '📵',
